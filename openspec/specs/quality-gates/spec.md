...
<!-- ASSUMPTION: The OpenSpec CLI provides accurate artifact dependency and status information -->
<!-- ASSUMPTION: Keyword-based code search provides reasonable (not perfect) implementation coverage detection -->
<!-- ASSUMPTION: constitution.md is the authoritative source for project rules and is kept up to date -->
