...
Provides `/opsx:docs` for generating user-facing capability documentation from merged baseline specs, and `/opsx:changelog` for generating release notes from archived spec changes.
