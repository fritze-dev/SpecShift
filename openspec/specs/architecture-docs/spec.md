...
Provides a cross-cutting architecture overview as part of the consolidated `docs/README.md` generated by `/opsx:docs`, synthesized from the project constitution, three-layer-architecture spec, and archived design decisions.
