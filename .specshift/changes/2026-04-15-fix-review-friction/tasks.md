...
- [ ] 2.1. [P] Edit `src/templates/workflow.md`: insert clean-tree check bullet between Draft transition and Review dispatch
- [ ] 2.2. [P] Edit `src/templates/workflow.md`: insert review-pending gate bullet between Pre-merge summary and Merge confirmation
- [ ] 2.3. [P] Edit `src/templates/workflow.md`: replace auto_approve wording (line 102) with explicit `request_review` config reference
- [ ] 2.4. [P] Edit `src/templates/workflow.md`: move "Set proposal status: completed" to before merge in Merge execution bullet
- [ ] 2.5. Edit `src/templates/workflow.md`: bump template-version 7 → 8
- [ ] 2.6. [P] Edit `.specshift/WORKFLOW.md`: mirror changes 2.1-2.4, preserving project-specific wording
- [ ] 2.7. Edit `.specshift/WORKFLOW.md`: bump template-version 7 → 8
