...
# Then open /plugins and install or enable SpecShift.
```
...
│   └── marketplace.json           # entry point for `codex plugin marketplace add owner/repo`
├── plugins/specshift/              # Generated Codex marketplace payload
