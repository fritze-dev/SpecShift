...
- `multi-target-distribution.md` v1 → 3: Per-Target Plugin Manifest revised for hand-edited root manifests with enrichment; Bootstrap SSOT revised — fresh init generates both AGENTS.md and the CLAUDE.md `@AGENTS.md` import stub; new **Agnostic Skill Body** requirement
