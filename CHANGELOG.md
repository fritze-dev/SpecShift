...
## 2026-04-13 — Enforce Template-Version Bump
...
### Fixed
- Template-version staleness can no longer silently reach consumers — previously relied on maintainer memory alone (closes #17)
