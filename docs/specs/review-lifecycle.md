...
- **Proposal missing Why or What Changes sections**: The action SHALL fall back to the PR body as the commit message. If the PR body is also empty, the action SHALL use the PR title only.
