...
| [Project Setup](capabilities/project-setup.md) | One-time project initialization with /opsx:init including CLI installation and validation |
...
| [Artifact Pipeline](capabilities/artifact-pipeline.md) | 6-stage pipeline (research through tasks) with strict dependency gating |
...
| [Constitution Management](capabilities/constitution-management.md) | Constitution generation from codebase, automatic updates during design, and global context enforcement |
