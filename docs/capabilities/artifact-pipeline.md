...
- **Eight-Stage Pipeline** (`specshift propose`): Research, proposal, specs, design, preflight, tests, tasks, and review execute in strict dependency order. Each stage produces a verifiable artifact file.
