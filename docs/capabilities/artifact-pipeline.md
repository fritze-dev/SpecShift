...
When progressing through the pipeline, the system enforces the order: research, proposal, specs, design, preflight, tests, tasks, audit. Attempting to skip a stage is rejected. A completed pipeline run produces `research.md`, `proposal.md`, one or more `specs/<capability>/spec.md` files, `design.md`, `preflight.md`, `tests.md`, `tasks.md`, and `audit.md`.
