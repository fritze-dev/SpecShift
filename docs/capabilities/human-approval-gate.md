...
Approval is only requested after all CRITICAL issues are resolved. You can approve with outstanding warnings. Every success metric from design.md appears as a PASS/FAIL checkbox in the QA loop section of tasks.md, and all must pass.
